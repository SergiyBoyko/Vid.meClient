...
public class User {
    ...
    @Expose
    private Boolean disallowDownloads;
    ...
    public Boolean getDisallowDownloads() {
        return disallowDownloads;
    }

    public void setDisallowDownloads(Boolean disallowDownloads) {
        this.disallowDownloads = disallowDownloads;
    }
